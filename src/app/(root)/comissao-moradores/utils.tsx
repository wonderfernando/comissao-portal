...
export  function retStatus(params:string) {
  ...
  export  function retStatusComissao(params:string) {
    if (params === "inativo") return <Badge variant="destructive"><CircleDashed className="mr-1" size={14}/> Inativo</Badge>
    if (params === "ativo") return <Badge variant="default"><CheckIcon size={14}/>Homologada</Badge>
   }