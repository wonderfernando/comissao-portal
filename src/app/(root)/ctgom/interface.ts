...
export const ctgomSchema = z.object({
  ...
  municipio_id: z.coerce.number("Selecione um município valido").min(1, "Município é obrigatório"),
    ...
    nome: z.string().min(0, "Título é obrigatório"),
    tipo: z.string().min(0, "Descrição é obrigatória"),
...
export type DocumentoTipo = "imagem" | "video" | "pdf" | "outro";

export interface CtgomDocumento {
  id: number;
  ctgom_id: number;
  tipo: DocumentoTipo;
  nome: string;
