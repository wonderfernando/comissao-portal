...
import TablePropostas from "../ctgom/[id]/components/table-projects"

 

export function PropostasCtgomView({ propostas }: { propostas: Proposta[] }) {
  return (
    <Card className="w-full">
        <CardHeader className="flex flex-col w-full items-center justify-between gap-4">
             <div className="flex items-center gap-4 w-full">
               <div>
                 <CardTitle className="text-xl">Administradores Municipais </CardTitle>
                 <Badge variant="outline">Utiliadores</Badge>
               </div>
             </div>
