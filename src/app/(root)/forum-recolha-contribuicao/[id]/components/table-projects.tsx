...
export const columns: ColumnDef<Proposta>[] = [
  ...
  {
    accessorKey: "custo_estimado",
    header: "Custo Estimado",
    cell: ({ row }) => <span>{
      Number(row.original.custo_estimado).toLocaleString('pt-AO', { style: 'currency', currency: 'AOA' })
      }</span>,
  },
  {
...
export default function TablePropostas( { className = "" , propostas}: { className?: string , propostas: Proposta[] }) {
  const id = useId()
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                ...
                >
                  Sem resultados. Clica em "Adicionar " para criar novo forum.
                </TableCell>
              </TableRow>
            )}
          </TableBody>
