...
import { getAnoAtividadeAction, getAnoSAtividadesAction } from "../../ano-atividade/actions"
...
const eventoSchema = z.object({
  ...
  ano_forum_id: z.coerce.number().min(1, "Selecione o ano de actividade").transform((val) => Number(val)),
  participantes: z
    .array(
      z.object({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-2xl flex flex-col">
        <DialogHeader>
          <DialogTitle>Registar Fórum de Contribuições</DialogTitle>
        </DialogHeader>
